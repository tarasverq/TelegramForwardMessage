...
namespace ProxyLib.Proxy
{
    ...
    public class ProxyClientFactory
    {
        ...
        public IProxyClient CreateProxyClient(ProxyDefinition definition)
        {
            return CreateProxyClient(definition.Type, definition.ProxyHost, definition.ProxyPort,
                definition.ProxyUsername, definition.ProxyPassword);
        }
            ...
            switch (type)
            {
                case ProxyType.Http:
                    return new HttpProxyClient(proxyHost, proxyPort, proxyUsername, proxyPassword)
                    {
                        ...
                        SendTimeout = (int) TimeSpan.FromSeconds(60).TotalMilliseconds
                    };
                case ProxyType.Socks4:

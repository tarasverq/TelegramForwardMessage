...
namespace Runner
{
    class Program
    {
       ...
       static async Task Main(string[] args)
       {
           ...
           var noLinkedChannel = File.ReadAllLines("no_linked_chat.txt").Distinct().ToList();
           var notFound = File.ReadAllLines("not_found.txt").Distinct().ToList();
       ...
       private static async Task<TelegramMessageForwarder> GetTelegramMessageForwarder(int clientId, string clientHash, string phone, Tuple<int, int> delay)
        {
            TelegramMessageForwarder messageForwarder = new TelegramMessageForwarder(clientId, clientHash, phone, delay);
